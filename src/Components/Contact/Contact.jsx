...
const Contact = () => (
  <section id="Contact" className="container-fluid bg-dark py-3 border-top border-dark">
    ...
    <div className="Body col-12 d-flex justify-content-center">
      <a href="http://github.com/alicandev" target="_blank" rel="noreferrer" className="Social btn btn-dark d-flex justify-content-center align-items-center rounded my-0">
      ...
      <a href="mailto:alicandev@icloud.com" target="_blank" rel="noreferrer" className="Social btn btn-dark d-flex justify-content-center align-items-center rounded my-0">
